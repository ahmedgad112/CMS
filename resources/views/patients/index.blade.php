...
@section('content')
    <div class="row mb-4">
        <div class="col-12">
                <div class="card shadow-sm border-0 patients-page-card">
                ...
                <div class="card-body p-4">
                    ...
                    <!-- Search Form -->
                    <form method="GET" action="{{ route('patients.index') }}" class="mb-3 patients-search-form">
                        <div class="row g-3">
                            <div class="col-md-10 col-12">
                                <div class="input-group input-group-lg patients-search-input-group">
                                ...
                                <tbody>
                                    @foreach ($patients as $patient)
                                        <tr>
                                            ...
                                            <td>
                                                <div
                                                    class="d-flex justify-content-end flex-wrap gap-2 patient-row-actions">
                                                    <a href="{{ route('patients.show', $patient->id) }}"
    ...
    @push('styles')
        <style>
            ...
            @media (max-width: 575.98px) {
                .patients-page-card .card-body {
                    padding: 1rem !important;
                }

                .patients-search-input-group.input-group-lg > .form-control,
                .patients-search-input-group.input-group-lg > .input-group-text {
                    font-size: 1rem;
                    padding: 0.5rem 0.75rem;
                }

                .patients-search-input-group.input-group-lg {
                    flex-wrap: nowrap;
                }
            ...
            @media (max-width: 767.98px) {
                ...
                .table-responsive.table--mobile-cards .table tbody tr:hover {
