            ...
            <div class="card-body p-4">
                ...
                <div class="alert alert-info mb-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <strong>ملاحظة مهمة:</strong> هذا الدور مرتبط بـ <strong>{{ $usersWithRole->count() }}</strong> مستخدم.
                            <br>
                            <small>أي تعديل في الصلاحيات سيتم تطبيقه تلقائياً على جميع المستخدمين الذين لديهم هذا الدور.</small>
                        </div>
                    </div>
                    @if($usersWithRole->count() <= 5)
                    <div class="mt-2">
                        <small class="text-muted">المستخدمون المتأثرون:</small>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="description" 
                                      ...
                                      rows="3"
                                      placeholder="وصف الدور...">{{ old('description', $role->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
