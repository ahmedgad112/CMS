        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-info text-white">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-0 fw-bold">إضافة تخصص جديد</h5>
                        <small class="opacity-75">أضف تخصص جديد لإدارة الأطباء</small>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="4"
                                      placeholder="أدخل وصفاً مختصراً عن التخصص...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
