...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'عرض طلبات الحجز', 'slug' => 'view_appointment_requests', 'category' => 'appointments', 'description' => 'عرض طلبات الحجز الواردة من الموقع'],
            ['name' => 'معالجة طلبات الحجز', 'slug' => 'process_appointment_requests', 'category' => 'appointments', 'description' => 'تأكيد أو إلغاء طلبات الحجز وتحويلها لمواعيد'],
            ...
            // Doctors directory
            ['name' => 'عرض الأطباء', 'slug' => 'view_doctors', 'category' => 'doctors', 'description' => 'عرض قائمة الأطباء وتفاصيلهم'],

            // Clinic structure (admin)
            ['name' => 'إدارة الأقسام', 'slug' => 'manage_departments', 'category' => 'admin', 'description' => 'إضافة وتعديل وحذف الأقسام'],
            ['name' => 'إدارة التخصصات', 'slug' => 'manage_specializations', 'category' => 'admin', 'description' => 'إضافة وتعديل وحذف التخصصات'],
            ['name' => 'إدارة العيادات', 'slug' => 'manage_clinics', 'category' => 'admin', 'description' => 'إضافة وتعديل وحذف العيادات وربط الأطباء بها'],
